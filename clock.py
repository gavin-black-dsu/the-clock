...
• Centered temperature readout with independent brightness and color
• Anti burn-in drift
"""
...
THEME_NAME, B_DAY, B_NIGHT, B_SUN, B_MOON, B_TEMP_DAY, B_TEMP_NIGHT, TEMP_COL_DAY, TEMP_COL_NIGHT = load_config(CONFIG_PATH)
